...
export const MessengerIcon = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./icon-Message-Bubble.png'),
  };

  return Icon(source, style);
};

export const ReportsIcon = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./icon-reports.png'),
  };

  return Icon(source, style);
};

export const AssignIcon = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./icon-assign.png'),
  };

  return Icon(source, style);
};

export const FleetIcon = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./icon-fleet.png'),
  };

  return Icon(source, style);
};

export const HardwareIcon = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./icon-hardware.png'),
  };
...
export const ArrowDownFill = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./eva/arrow-down.png'),
  };
...
export const EyeOnIconFill = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./eva/eye-on.png'),
  };
...
export const PersonIconOutline = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
...
export const HelpIconOutline = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
...
export const HardwareIconOutline = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
...
export const FleetIconFill = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./eva/car.png'),
  };
  return Icon(source, style);
};
export const AssignIconFill = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./eva/assign.png'),
  };
  return Icon(source, style);
};
export const HardwareIconFill = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./eva/hardware.png'),
  };
  return Icon(source, style);
};
